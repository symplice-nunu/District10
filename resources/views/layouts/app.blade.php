    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="{{ route('district10.index') }}" class="dec"><span class="las la-clipboard-list  "></span>
                ...
                <li>
                    <a href="{{ route('company.index') }}" class="dec"><span class="las la-users"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li><a class="nav-link" href="{{ route('company.index') }}">Manage Product</a></li>
